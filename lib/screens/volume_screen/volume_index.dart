...
import 'package:calculadora_imp_met/screens/volume_screen/volume.dart';
...
class RenderOption extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    switch (option) {
      ...
      case 'Gill (UK)':
        return GillUKScreen(gillUKInput: inputValue);
      case 'Barril (US)':
        return BarrelUSScreen(barrelUSInput: inputValue);
      case 'Barril (UK)':
